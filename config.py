...
示例输入：
    咳嗽3天
示例输出：
    患者于3天前无明显诱因出现咳嗽，呈阵发性，以干咳为主，偶有少量白色粘痰，不易咳出。咳嗽多在夜间或清晨加重，伴有轻度咽部不适，无明显胸痛、咯血或呼吸困难。患者自述无发热、寒战，无盗汗、乏力，无恶心、呕吐，无腹痛、腹泻等其他伴随症状。
...
约束：在现病史中，应该是时间+主诉症状描述，时间描述应自然融入，避免生硬的时间顺序。时间根据主诉中描述决定，如果是具体时长，则需用阿拉伯数字，如：3天、2年、1周。反之，则使用如"X天前"，"h小时前，X周前"等表达方式
"""
